...
import cn.finalteam.floatviewfinal.sample.R;

/**
 * 悬浮窗
 */
public class FloatView2 extends FrameLayout implements OnTouchListener {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == HANDLER_TYPE_HIDE_LOGO) {
                ...
                if (mCanHide) {
                    ...
                    mWindowManager.updateViewLayout(FloatView2.this, mWmParams);
    ...
    private View createView(final Context context) {
        ...
        // 从布局文件获取浮动窗口视图
        View rootFloatView = inflater.inflate(R.layout.pj_widget_float_view2, null);
        mFlFloatLogo = (FrameLayout) rootFloatView.findViewById(R.id.pj_float_view);
    ...
    public void show() {
        if (getVisibility() != View.VISIBLE) {
            ...
            if (mShowLoader) {
                ...
                mShowLoader = false;
                Animation rotaAnimation = AnimationUtils.loadAnimation(mContext, R.anim.pj_loading_anim);
